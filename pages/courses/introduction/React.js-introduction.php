...
<head>
    ...
    <title>React.js-introduction</title>
</head>
<body>
    ...
    <section class="container">
        <div class="cours__content">
            <div class="cours__left">
                <a class="lessons__list lessons__list-active" href="#">Первая программа на React</a>
                <br><br><br>
                <a class="lessons__list" href="#">Создание компонентов</a>
                <br><br><br>
                <a class="lessons__list" href="#">Рендер нескольких компонентов</a>
            </div>
            ...
            <div class="name__cours">
                <h1>React.js</h1>
                <a href="#">Courses &#8212 &gt React.js  &#8212 &gt Первая программа на React</a>
            </div>
            <div class="leson__description">
                <h2>Первая программа на React</h2>
